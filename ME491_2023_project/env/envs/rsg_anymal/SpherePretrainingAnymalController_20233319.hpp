...
class SpherePretrainingAnymalController_20233319 {
...
//      }
 ...
 private:
  ...
  int obDim_ = 0, obDimTeacher_ = 74, actionDim_ = 0;
...
thread_local std::mt19937 raisim::SpherePretrainingAnymalController_20233319::gen_;
thread_local std::uniform_real_distribution<double> raisim::SpherePretrainingAnymalController_20233319::uniDist_(0., 1.);
thread_local std::uniform_real_distribution<double> raisim::SpherePretrainingAnymalController_20233319::uniDistBothSide_(-1., 1.);
thread_local std::uniform_real_distribution<double> raisim::SpherePretrainingAnymalController_20233319::uniDistCage_(0.8, 1.2);
thread_local std::uniform_int_distribution<int> raisim::SpherePretrainingAnymalController_20233319::uniDistInt_(80, 200);
}
