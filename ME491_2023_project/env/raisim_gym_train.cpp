...
#include "EnvironmentTrain.hpp"
#include "VectorizedEnvironmentTrain.hpp"

namespace py = pybind11;
using namespace raisim;
int THREAD_COUNT = 1;

#ifndef ENVIRONMENT_NAME_TRAIN
#define ENVIRONMENT_NAME_TRAIN RaisimGymEnvTrain
#endif

PYBIND11_MODULE(RAISIMGYM_TORCH_ENV_NAME, m) {
  py::class_<VectorizedEnvironment<ENVIRONMENT>>(m, RSG_MAKE_STR(ENVIRONMENT_NAME_TRAIN))
      ...
      .def("setMode", &VectorizedEnvironment<ENVIRONMENT>::setMode)
      .def("checkCurriculum", &VectorizedEnvironment<ENVIRONMENT>::checkCurriculum)
      .def("getCurrLevel", &VectorizedEnvironment<ENVIRONMENT>::getCurrLevel)
      ...
      .def("getOpponentObDim", &VectorizedEnvironment<ENVIRONMENT>::getOpponentObDim)
      .def("getActionDim", &VectorizedEnvironment<ENVIRONMENT>::getActionDim)
      .def("getModeNum", &VectorizedEnvironment<ENVIRONMENT>::getModeNum)
      .def("getModeLevel", &VectorizedEnvironment<ENVIRONMENT>::getModeLevel)
      ...
      .def("modeUpdate", &VectorizedEnvironment<ENVIRONMENT>::modeUpdate)
      ...
      .def("setOpponentObStatistics", &VectorizedEnvironment<ENVIRONMENT>::setOpponentObStatistics)
      .def("setOpponentObStatistics2", &VectorizedEnvironment<ENVIRONMENT>::setOpponentObStatistics2)
      .def("setOpponentObStatistics3", &VectorizedEnvironment<ENVIRONMENT>::setOpponentObStatistics3)
      .def(py::pickle(
